    ...
    def __init__(self, *args, **kwargs):
        ...
        if item.ask_attendee_data and event.settings.attendee_names_asked:
            add_fields['attendee_name_parts'] = NamePartsFormField(
                ...
                help_text=_(
                    "Please ensure that the name provided matches your full legal name as it appears on your "
                    "photographic ID. If it doesn't, and you're unable to modify it here, please contact us "
